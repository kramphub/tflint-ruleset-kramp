...
#tflint-ignore: iam_policy_on_project_level, granting_permission_to_non_organization_principal
...
# Added this ignore to avoid other rule(s) to be triggered as well
#tflint-ignore: authoritative_iam_policy_on_project_level, granting_permission_to_non_organization_principal
...
# Added this ignore to avoid other rule(s) to be triggered as well
#tflint-ignore: granting_permission_to_non_organization_principal
...
# Added this ignore to avoid other rule(s) to be triggered as well
#tflint-ignore: authoritative_iam_policy_on_resource_level, granting_permission_to_non_organization_principal
